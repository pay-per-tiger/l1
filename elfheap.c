...
findheapimage32(u64 *len) {
	...
	sheader=(Elf32_Shdr *)(header + e->e_shoff);
	...
	strtab=(Elf32_Shdr *)(((unsigned char *)sheader) + e->e_shstrndx*e->e_shentsize);
	...
	for(x=0; x < e->e_shnum; x++) {
		...
		sheader=(Elf32_Shdr *)(((unsigned char *)sheader) + e->e_shentsize);
	}
